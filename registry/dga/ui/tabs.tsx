  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "after:absolute after:bottom-0 after:left-3 after:right-3 after:h-[2px] after:bg-[var(--colors-primary-s-a-flag500,#104631)] after:opacity-0 after:transition-opacity data-[state=active]:after:opacity-100",
        className
      )}
      {...props}
    />
