...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium hover:bg-[var(--colors-primary-s-a-flag600-primary)] hover:text-[var(--colors-base-white)] focus:bg-accent focus:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 data-[state=open]:hover:bg-[var(--colors-primary-s-a-flag600-primary)] data-[state=open]:text-[var(--colors-base-white)] data-[state=open]:focus:bg-accent data-[state=open]:bg-[var(--colors-primary-s-a-flag600-primary)] focus-visible:ring-ring/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1 relative after:absolute after:bottom-0 after:left-3 after:right-3 after:h-[4px] after:bg-[var(--colors-primary-s-a-flag400)] after:opacity-0 after:transition-opacity hover:after:opacity-100 data-[state=open]:after:opacity-100 h-full"
)
