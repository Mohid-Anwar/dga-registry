...
export const metadata = {
  title: "Radio Group",
  description:
    "DGA Radio Group component for React & Next.js. Accessible radio buttons with RTL layout support. Digital Government Authority Saudi Arabia design system.",
}
...
Pass `dir="rtl"` so arrow-key navigation follows the visual order as well as the
layout.
