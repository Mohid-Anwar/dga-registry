...
export default function RadioGroupDemo() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center px-4 py-12">
      ...
      <h1 className="mb-2 text-3xl font-bold">Radio Group Component Demo</h1>
      <p className="text-muted-foreground mb-10 max-w-2xl text-center">
        All variants and states of the <strong>Radio Group</strong> component,
        including different layouts, controlled usage, and form examples.
      </p>
      ...
      <section className="mb-14 w-full max-w-5xl">
        <h2 className="mb-1 text-xl font-semibold">1. Basic Radio Group</h2>
        <p className="text-muted-foreground mb-4 text-sm">
          Simple radio groups with default options.
        </p>
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-14 w-full max-w-5xl">
        <h2 className="mb-1 text-xl font-semibold">3. Controlled Radio Group</h2>
        <p className="text-muted-foreground mb-4 text-sm">
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-14 w-full max-w-5xl">
        <h2 className="mb-1 text-xl font-semibold">4. Horizontal Layout</h2>
        <p className="text-muted-foreground mb-4 text-sm">
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-14 w-full max-w-5xl">
        <h2 className="mb-1 text-xl font-semibold">7. Grid Layout</h2>
        <p className="text-muted-foreground mb-4 text-sm">
