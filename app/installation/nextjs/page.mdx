...
export const metadata = {
  ...
  description:
    "Install DGA Components in your Next.js project. Step-by-step guide for Digital Government Authority Saudi Arabia UI components with App Router, RSC, and RTL support.",
}
...
<InstallCommand
  variant="css-import"
  filename="Terminal"
  code="npx create-next-app@latest --src-dir"
/>
