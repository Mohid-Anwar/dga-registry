...
export const metadata = {
  ...
  description:
    "Install DGA Components in your Laravel project. Step-by-step guide for Digital Government Authority Saudi Arabia UI components with Inertia.js and RTL support.",
}
