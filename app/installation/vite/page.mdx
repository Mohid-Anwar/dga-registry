...
<InstallCommand variant="css-import" filename="Terminal" code="npm create vite@latest" />

### Add Tailwind CSS

If your project already has Tailwind CSS configured, skip this step.

<InstallCommand variant="css-import" filename="Terminal" code="npm install tailwindcss @tailwindcss/vite" />

Replace everything in `src/index.css` with the following:

<InstallCommand variant="css-import" filename="src/index.css" code={`@import "tailwindcss";`} />
...
<InstallCommand variant="css-import" filename="Terminal" code="npm install -D @types/node" />
