...
function useTranslation(translations: Translations, defaultLanguage: string) {
...
interface NavigationMenuRtlProps {
  dir: "rtl" | "ltr"
  lang: "ar" | "en"
}

export function NavigationMenuRtl({ dir, lang }: NavigationMenuRtlProps) {
