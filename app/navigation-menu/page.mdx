...
export const metadata = {
  title: "Navigation Menu – DGA Registry",
  description: "A collection of links for navigating websites with full RTL support.",
}
...
```bash
pnpm dlx shadcn add https://dga-registry.vercel.app/r/navigation-menu.json
```
