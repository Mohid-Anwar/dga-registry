...
export const metadata = {
  ...
  description:
    "DGA Navigation Menu component for React & Next.js. Accessible navigation links with full RTL and keyboard support. Digital Government Authority Saudi Arabia design system.",
}
