...
export default function CheckboxDemo() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center px-4 py-12">
      ...
      <h1 className="mb-2 text-3xl font-bold">Checkbox Component Demo</h1>
      <p className="text-muted-foreground mb-10 max-w-2xl text-center">
        All variants and states of the <strong>Checkbox</strong> component,
        including different states, controlled usage, and form examples.
      </p>
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-14 w-full max-w-5xl">
        <h2 className="mb-1 text-xl font-semibold">2. With Labels</h2>
        <p className="text-muted-foreground mb-4 text-sm">
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-14 w-full max-w-5xl">
        <h2 className="mb-1 text-xl font-semibold">3. Controlled Checkbox</h2>
        <p className="text-muted-foreground mb-4 text-sm">
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-14 w-full max-w-5xl">
        <h2 className="mb-1 text-xl font-semibold">4. Checkbox Groups</h2>
        <p className="text-muted-foreground mb-4 text-sm">
      ...
      <section className="mb-14 w-full max-w-5xl">
        <h2 className="mb-1 text-xl font-semibold">
          5. Pollutant Selection (Controlled Group)
        </h2>
        <p className="text-muted-foreground mb-4 text-sm">
          Select multiple pollutants for monitoring.
        </p>
        <div className="space-y-4">
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-14 w-full max-w-5xl">
        <h2 className="mb-1 text-xl font-semibold">7. Checkbox in Lists</h2>
        <p className="text-muted-foreground mb-4 text-sm">
