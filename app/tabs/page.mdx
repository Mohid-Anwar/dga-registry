...
export const metadata = {
  title: "Tabs",
  description:
    "DGA Tabs component for React & Next.js. Accessible tabbed content panels with RTL keyboard navigation. Digital Government Authority Saudi Arabia design system.",
}
...
Pass `dir="rtl"` so arrow-key navigation follows the visual tab order as well as the
layout.
